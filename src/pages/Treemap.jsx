...
class TreemapChart extends React.Component {
  componentDidMount() {
   ...
   var colorDomain =[10,100,1000,10000,1000000,1000000,10000000];
 ...
 /*   var treemap = d3.tree()
    ...
    function dataMap(root) {
      console.log("The logged dataObj", root);
      initialize(root);
      accumulate(root);
        ...
        g.append("rect")
          ...
          .on("click", function(d) {
            if (!d._children) {
              ...
              //   .enter()
              //   .append("g");
              // document.getElementById("chart").innerHTML = grandparent.append("last node")
              //   g.append("rect")
              // .attr("class", "children")
              // .call(rect)
              // .append("title")
